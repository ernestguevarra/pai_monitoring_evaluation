...
You can view previous daily reports from the archive as far back as **2022-05-11**. The links to previous reports can be found below:

```{r, echo = FALSE}
base_url <- "https://ernest.guevarra.io/pai_monitoring_evaluation/"

archive_dates <- seq(from = as.Date("2022-05-11"), to = Sys.Date(), by = "days")
